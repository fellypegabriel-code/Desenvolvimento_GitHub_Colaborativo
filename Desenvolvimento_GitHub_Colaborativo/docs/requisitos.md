...
* [RNF01] A interface deve ser desenvolvida em HTML5, CSS3 e JavaScript puro.
* [RNF02] O sistema deve rodar diretamente no navegador web, sem necessidade de banco de dados ou servidor.
